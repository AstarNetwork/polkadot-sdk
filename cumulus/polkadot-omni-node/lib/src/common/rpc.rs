...
pub trait BuildRpcExtensions<Client, Backend, Pool, StatementStore> {
...
// pub fn build_default_rpc_extensions<Block, RuntimeApi>(
// 	client: Arc<ParachainClient<Block, RuntimeApi>>,
// 	backend: Arc<ParachainBackend<Block>>,
// 	pool: Arc<sc_transaction_pool::TransactionPoolHandle<Block, ParachainClient<Block, RuntimeApi>>>,
// 	statement_store: Option<Arc<sc_statement_store::Store>>,
// ) -> sc_service::error::Result<RpcExtension>
// where
// 	Block: BlockT,
// 	RuntimeApi: ConstructNodeRuntimeApi<Block, ParachainClient<Block, RuntimeApi>> + Send + Sync + 'static,
